...
hyprcursor-util --create extracted_NieR_Cursors_${date}_XCursor
mv "theme_Extracted Theme" "nier_hyprcursors"
rm "nier_hyprcursors/manifest.hl"
echo "name = NierTheme
description = Hyprcursor theme based on NieR Automata 
release = ${date}
cursors_directory = hyprcursors" > nier_hyprcursors/manifest.hl
zip -q -r NieR_Hyprcursor_${date}.zip nier_hyprcursors/*

# Clean up
rm -r nier_hyprcursors
