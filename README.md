...
Download the [release](https://github.com/Beinsezii/NieR-Cursors/releases) archive for your operating system
 - Linux (XCursor/Hyprcursor theme): Unpack the archive and put the folder in your user icons folder (usually `~/.icons/`), then pick the cursor theme with whatever desktop/theme manager you use.
...
2. Have [win2xcur](https://github.com/quantum5/win2xcur) and [hyprcursor](https://github.com/hyprwm/hyprcursor) installed
2. Run `create_release.sh` file
3. Three files will be created:
    1. XCursor theme: 
